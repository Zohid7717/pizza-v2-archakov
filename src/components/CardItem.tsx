...
type CartItemProps = { id: string, name: string, type: string, sizes: number, price: number, count: number, imageUrl: string }

const CardItemBlock: FC<CartItemProps> = ({ id, name, type, sizes, price, count, imageUrl }) => {
